<?php return array (
  ...
  'BlogControllerCore' => 
  array (
    'path' => 'controllers/front/BlogController.php',
    'type' => 'class',
    'override' => false,
  ),
  'Blowfish' => 
  ...
  array (
    'path' => 'controllers/Core/Business/CMS/Core_Business_CMS_CMSRepository.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Business_CMS_CMSRoleRepository' => 
  array (
    'path' => 'controllers/Core/Business/CMS/Core_Business_CMS_CMSRoleRepository.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Business_ConfigurationInterface' => 
  array (
    'path' => 'controllers/Core/Business/Core_Business_ConfigurationInterface.php',
    'type' => 'interface',
    'override' => false,
  ),
  'Core_Business_ContainerBuilder' => 
  array (
    'path' => 'controllers/Core/Business/Core_Business_ContainerBuilder.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Business_Email_EmailLister' => 
  array (
    'path' => 'controllers/Core/Business/Email/Core_Business_Email_EmailLister.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Business_Payment_PaymentOption' => 
  array (
    'path' => 'controllers/Core/Business/Payment/Core_Business_Payment_PaymentOption.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Business_Stock_StockManager' => 
  array (
    'path' => 'controllers/Core/Business/Stock/Core_Business_Stock_StockManager.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Foundation_Database_DatabaseInterface' => 
  array (
    'path' => 'controllers/Core/Foundation/Database/Core_Foundation_Database_DatabaseInterface.php',
    'type' => 'interface',
    'override' => false,
  ),
  'Core_Foundation_Database_EntityInterface' => 
  array (
    'path' => 'controllers/Core/Foundation/Database/Core_Foundation_Database_EntityInterface.php',
    'type' => 'interface',
    'override' => false,
  ),
  'Core_Foundation_Database_EntityManager' => 
  array (
    'path' => 'controllers/Core/Foundation/Database/Core_Foundation_Database_EntityManager.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Foundation_Database_EntityManager_QueryBuilder' => 
  array (
    'path' => 'controllers/Core/Foundation/Database/EntityManager/Core_Foundation_Database_EntityManager_QueryBuilder.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Foundation_Database_EntityMetaData' => 
  array (
    'path' => 'controllers/Core/Foundation/Database/Core_Foundation_Database_EntityMetaData.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Foundation_Database_EntityRepository' => 
  array (
    'path' => 'controllers/Core/Foundation/Database/Core_Foundation_Database_EntityRepository.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Foundation_Database_Exception' => 
  array (
    'path' => 'controllers/Core/Foundation/Database/Core_Foundation_Database_Exception.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Foundation_Exception_Exception' => 
  array (
    'path' => 'controllers/Core/Foundation/Exception/Core_Foundation_Exception_Exception.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Foundation_FileSystem_Exception' => 
  array (
    'path' => 'controllers/Core/Foundation/Filesystem/Core_Foundation_FileSystem_Exception.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Foundation_FileSystem_FileSystem' => 
  array (
    'path' => 'controllers/Core/Foundation/Filesystem/Core_Foundation_FileSystem_FileSystem.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Foundation_IoC_Container' => 
  array (
    'path' => 'controllers/Core/Foundation/IoC/Core_Foundation_IoC_Container.php',
    'type' => 'class',
    'override' => false,
  ),
  'Core_Foundation_IoC_Exception' => 
  array (
    'path' => 'controllers/Core/Foundation/IoC/Core_Foundation_IoC_Exception.php',
    'type' => 'class',
    'override' => false,
  ),
  'Country' => 
