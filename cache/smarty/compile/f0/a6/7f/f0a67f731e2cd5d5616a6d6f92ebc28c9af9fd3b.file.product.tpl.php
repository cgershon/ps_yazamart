<?php /* Smarty version Smarty-3.1.19, created on 2016-11-27 22:49:55
         compiled from "/var/www/vhosts/konim.biz/ps_yazmart/themes/default-bootstrap/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2086812172583b46f31c9951-90746815%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f0a67f731e2cd5d5616a6d6f92ebc28c9af9fd3b' => 
    array (
      0 => '/var/www/vhosts/konim.biz/ps_yazmart/themes/default-bootstrap/product.tpl',
      1 => 1479200172,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2086812172583b46f31c9951-90746815',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583b46f42e9556_06923460',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583b46f42e9556_06923460')) {function content_583b46f42e9556_06923460($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/vhosts/konim.biz/ps_yazmart/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/var/www/vhosts/konim.biz/ps_yazmart/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/var/www/vhosts/konim.biz/ps_yazmart/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/var/www/vhosts/konim.biz/ps_yazmart/tools/smarty/plugins/function.counter.php';
?>
...
<script type= "text/javascript">
 ...
 //PaymentsTitle.legend|escape:'html':'UTF-8' ;  
   document.getElementById("Payments").innerHTML = " Payment";

 
  function myPayments() {
    var Nb = document.getElementById("mySelect").value;
   // alert(  Nb )    ;  
    if( Nb == 1)
     var PaymentsTitle =" Payment";
    else
     var PaymentsTitle =" Payments";
      document.getElementById("Payments").innerHTML = PaymentsTitle ;
      
        $.post( 'billing_cycle.php' , { Nb: Nb } );
					...
					<div class="product_attributes clearfix"  align="right" >
						<!-- quantity wanted -->
