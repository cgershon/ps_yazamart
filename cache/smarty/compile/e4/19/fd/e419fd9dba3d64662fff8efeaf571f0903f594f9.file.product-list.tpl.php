<?php /* Smarty version Smarty-3.1.19, created on 2016-11-27 14:20:17
         compiled from "/var/www/vhosts/konim.biz/ps_yazmart/modules/ph_simpleblog/views/templates/front/product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1489971551583acf813af796-99535042%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e419fd9dba3d64662fff8efeaf571f0903f594f9' => 
    array (
      0 => '/var/www/vhosts/konim.biz/ps_yazmart/modules/ph_simpleblog/views/templates/front/product-list.tpl',
      1 => 1480247869,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1489971551583acf813af796-99535042',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583acf81ba7bb8_65345057',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583acf81ba7bb8_65345057')) {function content_583acf81ba7bb8_65345057($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/vhosts/konim.biz/ps_yazmart/tools/smarty/plugins/function.math.php';
?>
...
" rel="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
">
							<span><?php echo smartyTranslate(array('s'=>'Quick view','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
</span>
						</a>
						<?php }?>
...
<?php } else { ?><?php echo smartyTranslate(array('s'=>'In Stock','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
<?php }?><?php } else { ?><?php echo smartyTranslate(array('s'=>'Out of stock','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
...
<?php }?><?php }?>
										<?php } elseif ((isset($_smarty_tpl->tpl_vars['product']->value['quantity_all_versions'])&&$_smarty_tpl->tpl_vars['product']->value['quantity_all_versions']>0)) {?>
												<link itemprop="availability" href="http://schema.org/LimitedAvailability" /><?php echo smartyTranslate(array('s'=>'Product available with different options','mod'=>'ph_simpleblog'),$_smarty_tpl);?>


										<?php } else { ?>
												<link itemprop="availability" href="http://schema.org/OutOfStock" /><?php echo smartyTranslate(array('s'=>'Out of stock','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
...
">
								<span class="new-label"><?php echo smartyTranslate(array('s'=>'New','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
</span>
							</a>
						<?php }?>
...
">
								<span class="sale-label"><?php echo smartyTranslate(array('s'=>'Sale!','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
</span>
							</a>
						<?php }?>
					</div>
...
" rel="nofollow" title="<?php echo smartyTranslate(array('s'=>'Add to cart','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
...
<?php }?>">
									<span><?php echo smartyTranslate(array('s'=>'Add to cart','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
</span>
								</a>
							<?php } else { ?>
...
" title="<?php echo smartyTranslate(array('s'=>'View','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
">
							<span><?php if ((isset($_smarty_tpl->tpl_vars['product']->value['customization_required'])&&$_smarty_tpl->tpl_vars['product']->value['customization_required'])) {?><?php echo smartyTranslate(array('s'=>'Customize','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'More','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
<?php }?></span>
						</a>
					</div>
					...
					<div class="product-flags">
						<?php if ((!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&((isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price'])||(isset($_smarty_tpl->tpl_vars['product']->value['available_for_order'])&&$_smarty_tpl->tpl_vars['product']->value['available_for_order'])))) {?>
							<?php if (isset($_smarty_tpl->tpl_vars['product']->value['online_only'])&&$_smarty_tpl->tpl_vars['product']->value['online_only']) {?>
								<span class="online_only"><?php echo smartyTranslate(array('s'=>'Online only','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
</span>
							<?php }?>
						<?php }?>
						<?php if (isset($_smarty_tpl->tpl_vars['product']->value['on_sale'])&&$_smarty_tpl->tpl_vars['product']->value['on_sale']&&isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price']&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
							<?php } elseif (isset($_smarty_tpl->tpl_vars['product']->value['reduction'])&&$_smarty_tpl->tpl_vars['product']->value['reduction']&&isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price']&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
								<span class="discount"><?php echo smartyTranslate(array('s'=>'Reduced price!','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
</span>
							<?php }?>
					</div>
...
<?php }?><?php }?>
								...
								<?php } elseif ((isset($_smarty_tpl->tpl_vars['product']->value['quantity_all_versions'])&&$_smarty_tpl->tpl_vars['product']->value['quantity_all_versions']>0)) {?>
									<span class="available-dif">
										<?php echo smartyTranslate(array('s'=>'Product available with different options','mod'=>'ph_simpleblog'),$_smarty_tpl);?>

									</span>
								<?php } else { ?>
									<span class="out-of-stock">
										<?php echo smartyTranslate(array('s'=>'Out of stock','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
