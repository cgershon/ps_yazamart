<?php /* Smarty version Smarty-3.1.19, created on 2016-11-27 14:11:45
         compiled from "/var/www/vhosts/konim.biz/ps_yazmart/modules/ph_simpleblog/views/templates/front/comments/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:403187796583acd81a01873-44801811%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c1c3820e144202d94d8ff3a226c630a9fdcb0bbb' => 
    array (
      0 => '/var/www/vhosts/konim.biz/ps_yazmart/modules/ph_simpleblog/views/templates/front/comments/form.tpl',
      1 => 1480236481,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '403187796583acd81a01873-44801811',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_583acd81ae7637_16790088',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_583acd81ae7637_16790088')) {function content_583acd81ae7637_16790088($_smarty_tpl) {?>
...
" method="post">
	<fieldset>
		<div class="box">
			<h3 class="page-heading bottom-indent"><?php echo smartyTranslate(array('s'=>'New comment','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
</h3>
			<div class="form-group">
				<label for="customer_name"><?php echo smartyTranslate(array('s'=>'Your name','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
</label>
...
<?php }?><?php }?>" />
			...
			<div class="form-group">
				<label for="comment_content"><?php echo smartyTranslate(array('s'=>'Your comment','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
</label>
...
" />
			...
			<button type="submit" class="button btn btn-default button-medium" name="submitNewComment" id="submitNewComment">
				<span>
					<?php echo smartyTranslate(array('s'=>'Add new comment','mod'=>'ph_simpleblog'),$_smarty_tpl);?>

					<i class="fa fa-chevron-right right"></i>
				</span>
			</button>
			<?php } else { ?>
			<input type="submit" class="button" name="submitNewComment" value="<?php echo smartyTranslate(array('s'=>'Add new comment','mod'=>'ph_simpleblog'),$_smarty_tpl);?>
" />
			<?php }?>
		</p>
	</fieldset>
