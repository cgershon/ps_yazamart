...
<div class="bestkit_paypal">
	...
	<div class="inner">
		<label>{l s='Period type:' mod='bestkit_psubscription'}</label>
		...
		<br/>
		<label>{l s='Start date:' mod='bestkit_psubscription'}</label>
		<input type="text" class="text start_date" readonly="readonly" name="start_date" style="border: 1px solid rgb(189, 194, 201);">
	</div>
</div>
<script>
