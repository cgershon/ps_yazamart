...
<div class="page-container">
    ...
    <div class="page-header-wrapper">
        <div class="page-header">
            ...
            <a class="company-logo" href="" target="_blank"><img src="img/logo yazamart-1.jpg" alt="YazamArt"></a>
        </div>
    </div>
    <!-- end: PAGE HEADER-->
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <div class="page-info-wrapper">
                 <div class="page-info">
                    <div class="page-info-heading" > ברוך הבא ל
                  יזם<font color="#FF0000">ארט</font></div><!--<script>document.write('<a href="http://' + (location.hostname.indexOf(':')>=0?'['+location.hostname+']':location.hostname) + '">' + location.hostname + '</a>');</script>-->
                    
                     <div class="" align="right">
                        <div class="product-info-content">
                          <strong style="text-align:justify"> חנות לאומנות </strong> 
                            <ul class="links">
                               <li><a class="" href="" target="_blank"><span>בלוג <br><img src="img/blog.png" alt="YazamArt"> </span></a>
                               </li>
                                <li><a class="" href="../ps_yazmart/index.php?id_lang=1" target="_blank">
                                <span>חנות<br><img src="img/globe.png" alt="YazamArt" width="60" height="60"></span></a>
                                </li>
                    ...
                    <!-- <p>If you are the owner of this website, one of the following60 things may be occurring:</p>
                    <ul>
   ...
   <!-- start: PAGE FOOTER-->
    <div class="page-footer-wrapper">
        <div class="page-footer">
            This page was generated by <a href="http://www.ygpc.net" target="_blank">YGPC</a>
            <span class="separator"></span>
            <a href="http://www.odin.com" target="_blank" class="copyright">© 2008 YGPC. All rights reserved.</a>
        </div>
    </div>
    <!-- end: PAGE FOOTER-->
</div>
